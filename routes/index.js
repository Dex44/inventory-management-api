...
router.get('/list-users', AuthGuard, validate(schema.pagination), ErrorHandler(UserController.listUsers));
...
router.get('/list-products', AuthGuard, validate(schema.pagination), ErrorHandler(ProductController.listProducts));
...
router.get('/list-roles', AuthGuard, validate(schema.pagination), ErrorHandler(RoleController.listRoles));
...
router.get('/list-clients', AuthGuard, validate(schema.pagination), ErrorHandler(ClientController.listClients));
